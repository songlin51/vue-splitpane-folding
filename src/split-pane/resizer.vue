...
<div @mouseenter="onMouseOver" @mouseleave="onMouseLeave">
    ...
    <div v-if=" split == 'vertical' && folding == true && foldingShow==true " class="splitter-pane-reset" :style="{ [resizeType]: percent+'%'}" @click="reset">
...
<script>
  export default {
    ...
    methods:{
      onMouseOver(){
        if(this.foldingType =='hidden'){
          this.foldingShow = true;
        }
      },
      onMouseLeave(){
        if(this.foldingType =='hidden'){
          this.foldingShow = false;
        }
      },
      onMouseDown(){
